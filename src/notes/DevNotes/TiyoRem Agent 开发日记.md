...
# 2026-06-24
感觉还需要评估一个任务完成后的心理满足度
就是有时候这些任务在这里，我知道哪个最紧急，但我会特别不想干
然后馍馍切换到某个任务之后会能够干下去（虽然可能不是最想做的事情，比如玩耍/coding）
然后干一点点，进入状态了，就可以切换到紧急任务

其实它的目的不是让我知道要按照事情的轻重缓急去做事，而是让我开始做事

another idea：为了使任务更快适应不同的场景，可以添加一些skill（template/loop），在弹出窗口里输入/xx启动相关命令，比如：
/搞懂 xxx
